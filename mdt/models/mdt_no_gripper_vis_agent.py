...
class MDTAgent(pl.LightningModule):
    ...
    def training_step(
        ...
        for self.modality_scope, dataset_batch in batch.items():
            ...
            if not isinstance(self.gen_img, NoEncoder):
                ...
                rgb_pred_goal = rgb_static_goal
                if len(rgb_pred_goal.shape) == 4:
                    rgb_pred_goal.unsqueeze(1)
    ...
    def validation_step(
        ...
        for self.modality_scope, dataset_batch in batch.items():
            ...
            if not isinstance(self.gen_img, NoEncoder):
                ...
                rgb_pred_goal = rgb_static_goal
                if len(rgb_pred_goal.shape) == 4:
                    rgb_pred_goal = rgb_pred_goal.unsqueeze(1)
    ...
    def embed_visual_obs(self, rgb_static):
